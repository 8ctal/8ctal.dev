// Ported from vercel-labs/vgpu (MIT License, Copyright (c) 2025 Vercel, Inc.)
// https://github.com/vercel-labs/vgpu/tree/main/apps/docs/examples/black-hole
// Only change from upstream: the four .wgsl imports gained a `?raw` suffix —
// Vite's built-in raw-import feature, since this project has no bundler
// loader configured for the bare .wgsl extension the original (Next.js/
// Turbopack) build used.
import {
  effect,
  sampler,
  target,
...
import blackHoleWgsl from './black-hole.wgsl?raw';
import blurWgsl from './blur.wgsl?raw';
import brightPassWgsl from './bright-pass.wgsl?raw';
