 ...
 *   from the reference.
 */
const BlurText = ({ text, className = "", as: Tag = "span" }) => {
    ...
    const words = useMemo(() => {
        ...
        // Recomputed only when the text itself changes — not on every
        // render — so the randomized timing doesn't reshuffle mid-animation.
