// Ported from ref_components/Ruixen_Gradient_Footer.tsx (21st.dev community
// component, `npx shadcn add "https://21st.dev/r/ruixen.ui/ruixen-gradient-footer"`).
// Only TS syntax was stripped (the `Stop` type, the props interface, and a
// couple of parameter type annotations on plain helper functions) — the
// rendering logic, including every comment, is otherwise unchanged.
//
// This is a second, deliberate exception to DESIGN.md's "Regla de la
// Chispa Única" (the neon gradient confined to the Experience timeline) —
// see the note added there. The footer was explicitly asked for by this
// exact reference component; scoping the rule to "the timeline and the
// footer's closing glow, and nowhere else" keeps it a real rule rather than
